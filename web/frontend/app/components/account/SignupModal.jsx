    ...
    <div className=' w-[550px] h-[525px] bg-black bg-opacity-50 rounded-3xl'>
        <div className=' p-12 flex items-center justify-center flex-col '>
            <div className='items-center justify-center flex flex-col'>
                <h1 className=' text-3xl font-semibold mt-8'>Sign Up</h1>
                <h2 className=' text-lg mt-2 text-zinc-300'>Welcome to our Cosmobot</h2>
                <div className=' -mt-1 flex flex-row'>
                    <h3 className=' text-zinc-600 font-semibold '>Already have an account? </h3>
                    <Link href="/" className=' text-purple-700 font-semibold ml-2 hover:underline'> Log In </Link>
                </div>
            </div>
            <div className=' flex flex-col'>
              <form action='post' className=' flex flex-col text-zinc-600 mt-6 '>
                <h3 className=' text-zinc-400 '> Sign Up with your email</h3>
